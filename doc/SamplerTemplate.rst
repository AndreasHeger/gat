...
.. figure:: ../test/benchmark/testSingleWorkspace.TestSegmentSampling%%%.png
   :width: 500

   Single continuous workspace.

.. figure:: ../test/benchmark/testSingleWorkspaceWithOffset.TestSegmentSampling%%%.png
   :width: 500
...
.. figure:: ../test/benchmark/testFullWorkspace.TestSegmentSampling%%%.png
   :width: 500
...
.. figure:: ../test/benchmark/testSmallWorkspace.TestSegmentSampling%%%.png
   :width: 500
...
.. figure:: ../test/benchmark/testSegmentedWorkspaceSmallGap.TestSegmentSampling%%%.png
   :width: 500

   Workspace segmented into 10 segments of size 999 with a single nucleotide
   gap between workspaces.

.. figure:: ../test/benchmark/testSegmentedWorkspaceLargeGap.TestSegmentSampling%%%.png
   :width: 500

   Workspace segmented into 10 segments of size 900 with a 100 nucleotide
   gap between workspaces.

.. figure:: ../test/benchmark/testSegmentedWorkspace2x.TestSegmentSampling%%%.png
   :width: 500
...
.. figure:: ../test/benchmark/testSegmentedWorkspaceSmallGapUnequalSides.TestSegmentSampling%%%.png
   :width: 500

   A segmented workspace of size 100 split at position 50 with a gap of 25. There is 
   a single segment of size 50.

.. figure:: ../test/benchmark/testSegmentedWorkspaceSmallGapEqualSides.TestSegmentSampling%%%.png
   :width: 500
